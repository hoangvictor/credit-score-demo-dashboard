                        ...
                        <Field>
                            {({ field, form }) => (
                                <FormControl name="identity_number" id="identity_number" onChange={props.handleChange} style={{ marginBottom: "10px" }} htmlFor="identity_number">
                                    ...
                                    <Input style={{ color: 'white' }} type='number' defaultValue={cookies.get('infoResponse') != null ? cookies.get('infoResponse').identityNumber : null} />
                                </FormControl>
                            )}
                        </Field>
                        <Field>
                            {({ field, form }) => (
                                <FormControl name="loan_type" id="loan_type" style={{ marginBottom: "10px"}} htmlFor="loan_type">
                                    ...
                                    <Select name="loan_type" id="loan_type" onChange={props.handleChange} style={{ color: 'white' }} placeholder='Select the loan type' defaultValue='Mortgage'>
                                        <option style={{ color: 'white' }} value="Mortgage">Mortgage</option>
                                        <option style={{ color: 'white' }} value="Unsecured Loan">Unsecured Loan</option>
                                    </Select>
                                </FormControl>
                            )}
                        </Field>
                        <Field>
                            {({ field, form }) => (
                                <FormControl name="loan_value" id="loan_value" onChange={props.handleChange} style={{ marginBottom: "10px" }} htmlFor="loan_value">
                                    ...
                                    <Input style={{ color: 'white' }} type='number' defaultValue={20} />
                                </FormControl>
                            )}
                        </Field>
                        <Field>
                            {({ field, form }) => (
                                <FormControl name="collateral_value" id="collateral_value" onChange={props.handleChange} style={{ marginBottom: "10px" }} htmlFor="collateral_value">
                                    ...
                                    <Input style={{ color: 'white' }} type='number' defaultValue={665} />
                                </FormControl>
                            )}
                        </Field>
                        <Button
